...
let UserService = class UserService {
    ...
    async editUser(editUserDto, userId, file) {
        try {
            const myUser = await this.UserModel.findById(userId);
            console.log(...oo_oo(`a66f299e_0`, myUser.image));
            console.log(...oo_oo(`a66f299e_1`, file));
