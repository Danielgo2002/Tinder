...
var AnimatedSpan = /*#__PURE__*/framerMotion.motion(react.chakra.span);
var animationConfig = {
  transition: {
    duration: 0.25
  },
...
var StepIcon = /*#__PURE__*/react.forwardRef(function (props, ref) {
  var _useStyles = react.useStyles(),
  ...
  return React__default.useMemo(function () {
    ...
    if (isCurrentStep) {
      ...
      if (isLoading) return React__default.createElement(react.Spinner, {
        width: icon.width,
        height: icon.height
      });
    }
...
var StepLabel = function StepLabel(_ref) {
  ...
  return shouldRender ? React__default.createElement(react.chakra.div, {
    "aria-current": isCurrentStep ? 'step' : undefined,
    __css: _extends({
      textAlign: isLabelVertical ? 'center' : 'left',
      alignItems: isLabelVertical ? 'center' : 'flex-start'
    }, labelContainer)
  }, !!label && React__default.createElement(react.chakra.span, {
    __css: _extends({
      mx: isLabelVertical ? 0 : 2,
      mt: isLabelVertical ? 1 : 0,
      opacity: opacity
    }, labelStyles)
  }, label), !!description && React__default.createElement(react.chakra.span, {
    __css: _extends({
      mx: isLabelVertical ? 0 : 2,
...
var Step = /*#__PURE__*/system.forwardRef(function (props, ref) {
  ...
  }, styleProps), React.createElement(system.chakra.div, {
    ref: containerRef,
    __css: _extends({
  ...
  }, React.createElement(StepIcon, Object.assign({}, {
    index: index,
    isError: isError,
    isLoading: isLoading,
...
var Steps = /*#__PURE__*/system.forwardRef(function (props, ref) {
  ...
  return React.createElement(system.StylesProvider, {
    value: styles
  }, React.createElement(StepsProvider, {
    value: {
